...
always @(sdramCntl_inst_bank_s, sdramCntl_inst_wrTimer_r, sdramCntl_inst_row_s, sdramCntl_inst_rdInProgress_s, sdramCntl_inst_activeBank_r, sdramCntl_inst_refTimer_r, sdramCntl_inst_activateInProgress_s, sdramCntl_inst_activeFlag_r[0], sdramCntl_inst_activeFlag_r[1], sdramCntl_inst_activeFlag_r[2], sdramCntl_inst_activeFlag_r[3], sdramCntl_inst_ba_x, sdramCntl_inst_activeRow_r[0], sdramCntl_inst_activeRow_r[1], sdramCntl_inst_activeRow_r[2], sdramCntl_inst_activeRow_r[3], sdramCntl_inst_rfshCntr_r, sdramCntl_inst_writeInProgress_s, sdramCntl_inst_col_s, sdramCntl_inst_host_intf_wr_i, sdramCntl_inst_timer_r, sdramCntl_inst_doActivate_s, sdramCntl_inst_host_intf_rd_i, sdramCntl_inst_rasTimer_r, sdramCntl_inst_state_r, sdramCntl_inst_sAddr_r, sdramCntl_inst_sDataDir_r, sdramCntl_inst_ba_r, sdramCntl_inst_rdPipeline_r) begin: SDRAM_TEST_SDRAMCNTL_INST_COMB_FUNC
    integer index;
...
always @(sdramCntl_inst_sData_r, sdramCntl_inst_bank_s, sdramCntl_inst_cmd_r, sdramCntl_inst_sAddr_r, sdramCntl_inst_sDataDir_r) begin: SDRAM_TEST_SDRAMCNTL_INST_SDRAM_PIN_MAP
    sd_intf_cke = 1;
    sd_intf_cs = 0;
...
always @(sd_intf_dq, sdramCntl_inst_rasTimer_r, sdramCntl_inst_sdramData_r, sdramCntl_inst_activeFlag_r[0], sdramCntl_inst_activeFlag_r[1], sdramCntl_inst_activeFlag_r[2], sdramCntl_inst_activeFlag_r[3], sdramCntl_inst_bank_s, sdramCntl_inst_wrTimer_r, sdramCntl_inst_row_s, sdramCntl_inst_activeRow_r[0], sdramCntl_inst_activeRow_r[1], sdramCntl_inst_activeRow_r[2], sdramCntl_inst_activeRow_r[3], sdramCntl_inst_rdPipeline_r, sdramCntl_inst_activeBank_r) begin: SDRAM_TEST_SDRAMCNTL_INST_DO_ACTIVE
